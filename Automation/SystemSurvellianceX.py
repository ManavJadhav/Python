...
def CreateLog(FolderName):
    ...
    FileName = os.path.join(FolderName,"Info%s.log" %timestamp)
    print("Log file gets craeted with name : ",FileName)

    fobj = open(FileName,"w")

    fobj.write(Border+"\n")
    fobj.write("---- Platform Survelliance System -----\n")
...
def main():
    ...
    Border = "-"*40
    print(Border)
    print("---- Platform Survelliance System -----")
    print(Border)
    ...
    if(len(sys.argv)== 2):
        ...
        print("Platform Survelliance System started successfully")

...
def AnalyzeData(df):
    ...
    print("Performance Index values are :", df["PerformanceIndex"])
...
def main():
    ...
    # and SleepHours contribute less.
...
# After adding the new feature 'PerformanceIndex' in the dataset, the accuracy still remains the same.

...
# Description : This function is used to visualize the trained decision tree
#-----------------------------------------------------------------------------------------------------
def DrawDecisionTree(trained_model, X, Y):

    print(Border)
    print("Visualising the trained decision tree")
    print(Border)
...
# Description : Custom function to calculate testing accuracy manually
#-----------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------
# Function    : TestModel
# Description : This function is used to test the trained model
#-----------------------------------------------------------------------------------------------------
...
def main():
    ...
    DrawDecisionTree(trained_model, X, Y)
...
# The feature which appeared at the root is Attendance.
# This feature was selected because it has the highest importance score
# according to feature_importances_ in the trained Decision Tree model.

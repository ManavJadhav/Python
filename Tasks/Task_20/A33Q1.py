...
# Input            : Time interval (minutes) and Directory name (command line arguments)
# Output           : Creates periodic system monitoring log files inside specified directory
...
#                    Generates log files automatically using scheduling.
...
def CreateLog(FolderName):
    ...
    FileName = os.path.join(FolderName,"SystemReport_%s.log" %timestamp)
...
def main():
    ...
    if(len(sys.argv)== 2):
        ...
        if(sys.argv[1] == "--h" or sys.argv[1] == "--H"):
            ...
            print("1 : Create automatic system log")
            print("2 : Execute periodically")
            print("3 : Store CPU, RAM, disk and process information")

#=====================================================================================================
# Program Name     : DirectoryDuplicate
# Input            : Directory name (command line argument)
# Output           : Writes duplicate file names into Log.txt
# Description      : Traverses a directory recursively, calculates MD5 checksum
#                    for each file, and identifies duplicate files based on checksum.
...
#------------------------------------------------------------------------
# Function    : DirectoryDuplicate
# Description : Identifies duplicate files and writes them into log file
#------------------------------------------------------------------------

def DirectoryDuplicate(Path = "Demo"):
    ...
    fobj.write(Border + "\n")
    fobj.write("This Script is generated by DirectoryDuplicate Automation \n")
    fobj.write(Border + "\n")
    ...
    for value in Result:
        for subvalue in value:
            Count = Count + 1
            if(Count >1 ):
                fobj.write("Duplicate file is : "+subvalue+"\n")
        Count = 0
...
def main():
    ...
    Border = "-" * 50
    print(Border)
    print("------------ Directory Duplicate File Logging Automation -----------")
    print(Border)
    ...
    if(len(sys.argv) == 2):
        ...
        if((sys.argv[1]== "--h") or (sys.argv[1]== "--H")):
            ...
            print("Identify duplicate files in a directory using checksum comparison")
        ...
        schedule.every(interval).minutes.do(DirectoryDuplicate, sys.argv[1])

...
# Description       : Builds, trains, tests, and evaluates a Decision Tree model. Calculates training 
#                     & testing accuracy, and displays predictions with a confusion matrix.
...
#-----------------------------------------------------------------------------------------------------
# Function    : TrainModel
# Description : Trains the model using X_train and Y_train, returns trained model
...
#-----------------------------------------------------------------------------------------------------
# Function    : BuildModel
# Description : Builds a Decision Tree model with max_depth=3 and returns it
# Input       : None
...
def main():
    ...
    # Observations:
    # if max_depth = 3 & test_size=0.2 => TestingAccuracy is 100%
    # if max_depth = 3 & test_size=0.5 => TestingAccuracy is 93.3%

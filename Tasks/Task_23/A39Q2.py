...
# Description       : Builds, trains, and evaluates a Decision Tree model to predict student performance
# Input             : student_performance_ml.csv
# Output            : Predicted Final Result and comparison with actual results
...
# Description      : Tests the trained model on the test dataset and prints predictions vs actual.
# Input            : X_test (DataFrame), Y_test (Series), trained_model (sklearn classifier)
# Output           : Prints expected and predicted results
#-----------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------
# Function Name    : main
# Description      : Driver function to execute complete workflow: load data, analyze, split, build, train and test model.
#-----------------------------------------------------------------------------------------------------
def main():
    df = load_data()
    X, Y = analyze_data(df)

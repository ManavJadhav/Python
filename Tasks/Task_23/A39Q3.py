...
# Description       : Builds, trains, tests, and evaluates a Decision Tree model to predict student performance
# Input             : student_performance_ml.csv
# Output            : Predicted Final Result and Accuracy Score
...
#-----------------------------------------------------------------------------------------------------
# Function Name    : main
# Description      : Driver function to execute complete workflow: load data, analyze, split, build, train, test and calculate accuracy.
#-----------------------------------------------------------------------------------------------------
def main():
    df = load_data()
    X, Y = analyze_data(df)
